...
subcat_x0[10] = new Array("问题识别","语义识别","question_if");
subcat_x0[11] = new Array("短文本相似度","文本处理","similar_shorttxt");
subcat_x0[12] = new Array("答案抽取_相似度","文本处理","answer_extract_similar");
onecount_x0=13;
